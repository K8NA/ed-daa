...
public class TestMax {
   ...
   // soma do array - divide o array entre o primeiro elemento e o resto do array
   static int sumRec1(int v[], int start, int end) {
      if (start == end) return v[start];
      return v[start] + sumRec1(v, start+1, end);
   }

   // soma do array - divide o array entre metade esquerda e metade direita
   ...
   public static void main(String[] args) {
      int v[] = {1,5,2,8,4,3,7,6}; // max = 8, sum = 36
